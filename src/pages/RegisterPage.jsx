...
const RegisterPage = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#050314] text-white px-4 sm:px-6 lg:px-8 py-12 relative overflow-hidden font-sans selection:bg-pink-500 selection:text-white">
      ...
      <div className="w-full max-w-md space-y-8 rounded-2xl border border-neutral-800/80 bg-neutral-900/40 backdrop-blur-md p-8 shadow-2xl relative z-10 hover:border-neutral-700/80 transition-all duration-300">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-xl font-bold tracking-tight text-white font-display">Create your account</h2>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div>
            <label className="block text-[10px] font-bold text-neutral-450 uppercase tracking-widest font-mono mb-2.5">Join Platform As</label>
            <div className="grid grid-cols-3 gap-2 rounded-xl bg-neutral-950 p-1 border border-neutral-800/60">
          ...
          <div className="space-y-4">
            <div>
              <label htmlFor="name" className="block text-[10px] font-bold text-neutral-450 uppercase tracking-widest font-mono">Full Name</label>
            ...
            <div>
              <label htmlFor="phone" className="block text-[10px] font-bold text-neutral-450 uppercase tracking-widest font-mono">Phone Number</label>
              <div className="relative mt-1.5">
                <div className="absolute inset-y-0 left-0 flex items-center pl-3.5 text-neutral-500">
                  <Phone size={16} />
                </div>
